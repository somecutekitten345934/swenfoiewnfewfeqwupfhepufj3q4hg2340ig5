...
module.exports = {
    name: "creampie",
    aliases: ["creampie"],
    description: 'So hot, sticky, and inside uwu **NSFW CHANNEL ONLY**',
    category: "nsfw",
    usage: 'test',
    async run(client, message, args) {
        if(!message.channel.nsfw){
            ...
            const image = hmtai.nsfw.creampie()
            ...
            try {
                message.channel.send({
                    ...
                    .setTitle(message.author.tag + " has requested a creampie for " + user.tag + "!")
                    .setImage(image)]
                });
            } catch(error){
