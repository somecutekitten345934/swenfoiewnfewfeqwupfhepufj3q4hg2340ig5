...
module.exports = {
    name: "cum",
    aliases: ["cum"],
    description: 'Basically sticky white stuff that is usually milked from sharpies **NSFW CHANNEL ONLY**',
    category: "nsfw",
    usage: 'test',
        ...
        if(!message.channel.nsfw){
            ...
            try {
                message.channel.send({
                    ...
                    .setTitle(message.author.tag + " has requested some cum for " + user.tag + "!")
                    .setImage(image)]
                });
            } catch(error){
