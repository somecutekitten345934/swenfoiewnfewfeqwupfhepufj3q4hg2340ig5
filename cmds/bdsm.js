...
module.exports = {
    name: "bdsm",
    aliases: ["bdsm"],
    description: 'If you don\'t know what it is search it up **NSFW CHANNEL ONLY**',
    category: "nsfw",
    usage: 'test',
        ...
        if(!message.channel.nsfw){
            ...
            try {
                message.channel.send({
                    ...
                    .setTitle(message.author.tag + " has requested bdsm for " + user.tag + "!")
                    .setImage(image)]
                });
            } catch(error){
